...
const familiarHawkerActiveIcon = '/images/front-end/sidebar_my_acquaintance_active.png'

const myIcon = '/images/front-end/sidebar_auth_login_data.png'
const myActiveIcon = '/images/front-end/sidebar_auth_login_data_active.png'
...
const SideNav = ({ me, myPriceTotal }) => {
    ...
    return (
        <StyledFlexBox display={["none", "none", "block"]}>
            <SidebarWrapper>
                <SidebarHeader className="sidebar-header">
                    <div className="align-items-center">
                        <Avatar className="d-block avatar avatar-xl mb-3 mx-auto"
                                style={{ width: '98px', height: '98px' }}>
                            <img src={photo} alt="Face 1" className="w-100 h-100" />
                        </Avatar>
                        <div className="text-center">
                            <h6 className="name-id text-primary" style={{ fontWeight: '400', letterSpacing: '0.14em' }}>
                                {name}
                            </h6>
                            <h6 className="mb-0 mt-4 text-primary">累積營業額：<span
                                className="text-danger">{numberWithThousandCommas(myPriceTotal)}</span>元
                            </h6>
                        </div>
                    </div>
                </SidebarHeader>

                <hr style={{ marginLeft: '40px', marginRight: '40px', border: '1px solid #26B7BC' }} />
                ...
                <SidebarMenu className="sidebar-menu pb-5">
                    <MenuUl className="menu">
                                    ...
                                    ({ isActive }) => {
                                        return <>
                                            <div className="icon-wrapper">
                                                <img src={isActive ? indexActiveIcon : indexIcon} alt="" />
                                            </div>
                        ...
                        <SidebarList id="cate2" className="sidebar-item">
                            <SidebarLink to="/message" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                                            <div className="icon-wrapper">
                                                <img src={isActive ? messageActiveIcon : messageIcon} alt="" />
                                            </div>
                                            <span className="ms-4">訊息通知
                                                 <span
                                                     className={`count ms-2 rounded-circle px-2 ${isActive ? 'active' : ''}`}>{pushNotifyCount}
                                            </span>
                                            </span>
                                        </>
                                    }
                        ...
                        <SidebarList id="cate3" className="sidebar-item">
                            <SidebarLink to="/open" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                                            <div className="icon-wrapper">
                                                <img src={isActive ? openActiveIcon : openIcon} alt="" />
                                            </div>
                        ...
                        <SidebarList id="cate4" className="sidebar-item">
                            <SidebarLink to="/ing" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                                            <div className="icon-wrapper">
                                                <img src={isActive ? ingActiveIcon : ingIcon} alt="" />
                                            </div>
                        ...
                        <SidebarList id="cate5" className="sidebar-item">
                            <SidebarLink to="/end" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                                            <div className="icon-wrapper">
                                                <img src={isActive ? endActiveIcon : endIcon} alt="" />
                                            </div>
                        ...
                        <SidebarList id="cate6" className="sidebar-item">
                            <SidebarLink to="/familiar-hawker" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                                            <div className="icon-wrapper">
                                                <img src={isActive ? familiarHawkerActiveIcon : familiarHawkerIcon}
                                                     alt="" />
                                            </div>
                        ...
                        <SidebarList id="cate7" className="sidebar-item">
                            <SidebarLink to="/my" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                        ...
                        <SidebarList id="cate8" className="sidebar-item">
                            <SidebarLink to="/reset-password" className={({ isActive }) => isActive ? 'active' : ''}>
                                {
                                    ({ isActive }) => {
                                        return <>
                                            <div className={`icon-wrapper ${isActive ? 'active' : ''}`}>
